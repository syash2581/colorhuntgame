...
public class Main26Activity extends AppCompatActivity {
            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main26Activity.this,Main2Activity.class);
                        Main26Activity.this.startActivity(intent);
                        Main26Activity.this.finish();
                    }
                });
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main26Activity.this.finish();
                        Intent intent=new Intent(Main26Activity.this,Main26Activity.class);
                        Main26Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
                ...
                if(i1==0)
                {
                  // pass();
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"4"+"&glevel="+"1"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main26Activity.this);
    ...
    public void pass()
    {
        ...
        adb.setPositiveButton("Next", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface di, int id){
                Intent intent=new Intent(Main26Activity.this,Main27Activity.class);
                Main26Activity.this.startActivity(intent);
                Main26Activity.this.finish();
            }
        });
