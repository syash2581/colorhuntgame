...
public class Main15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Main15Activity.this);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main15Activity.this,Main19Activity.class);
                Main15Activity.this.startActivity(intent);
                Main15Activity.this.finish();
            }
        });
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main15Activity.this,Main20Activity.class);
                Main15Activity.this.startActivity(intent);
                Main15Activity.this.finish();
            }
        });
        b6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main15Activity.this,Main21Activity.class);
                Main15Activity.this.startActivity(intent);
                Main15Activity.this.finish();
        ...
        b7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main15Activity.this,Main22Activity.class);
                Main15Activity.this.startActivity(intent);
                Main15Activity.this.finish();
            }
        });
        b8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main15Activity.this,Main23Activity.class);
                Main15Activity.this.startActivity(intent);
                Main15Activity.this.finish();
            }
        });
        b9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main15Activity.this,Main24Activity.class);
                Main15Activity.this.startActivity(intent);
                Main15Activity.this.finish();
            }
        });
    ...
    public void test()
    {
        switch (lvl)
        {
            case 0:
                ...
                adb.setMessage("=>There is a word of color name.\n=>Also having such type of attribute like the word is green but the color of text(green) is may be either same or different.\n=>In this game select a specific color that match with given text-color not select a color that match with word");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Main15Activity.this,Main4Activity.class);
        Main15Activity.this.startActivity(intent);
        Main15Activity.this.finish();
    }
}
