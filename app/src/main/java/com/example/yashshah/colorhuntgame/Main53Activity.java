            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main53Activity.this,Main2Activity.class);
                        Main53Activity.this.startActivity(intent);
                        Main53Activity.this.finish();
                    }
                });
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main53Activity.this.finish();
                        Intent intent=new Intent(Main53Activity.this,Main53Activity.class);
                        Main53Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
    ...
    public void set()
    {
        ...
        else
        {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET,
                    "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"5"+"&glevel="+"8"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    new Response.Listener<String>(){
                        @Override
                        public void onResponse(String response){
//                                        Toast.makeText(Main53Activity.this,"In onResponse Method",Toast.LENGTH_LONG).show();
                            if (response.trim().equalsIgnoreCase("Failure")){
                                progress.dismiss();
                                //pass();
                                //Toast.makeText(Main53Activity.this, response+"Invalid user id or Password or\nmay be user is not registered", Toast.LENGTH_LONG).show();
                            }else {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(Main53Activity.this, error.toString(), Toast.LENGTH_LONG).show();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Main53Activity.this);
    ...
    public void passed()
    {
        ...
        adb.setPositiveButton("Next", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface di, int id){
                Intent intent=new Intent(Main53Activity.this,Main54Activity.class);
                Main53Activity.this.startActivity(intent);
                Main53Activity.this.finish();
            }
        });
