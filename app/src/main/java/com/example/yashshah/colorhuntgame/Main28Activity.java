            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main28Activity.this,Main2Activity.class);
                        Main28Activity.this.startActivity(intent);
                        Main28Activity.this.finish();
                    }
                });
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main28Activity.this.finish();
                        Intent intent=new Intent(Main28Activity.this,Main28Activity.class);
                        Main28Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
...
//                   pass();
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"4"+"&glevel="+"3"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main28Activity.this);
