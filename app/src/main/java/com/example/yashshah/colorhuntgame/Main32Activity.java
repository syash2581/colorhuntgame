...
public class Main32Activity extends AppCompatActivity {
            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main32Activity.this,Main2Activity.class);
                        Main32Activity.this.startActivity(intent);
                ...
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main32Activity.this.finish();
                        Intent intent=new Intent(Main32Activity.this,Main32Activity.class);
                        Main32Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
                ...
                if(i1==0)
                {
                   // pass();
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"4"+"&glevel="+"7"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main32Activity.this);
    ...
    public void pass()
    {
        ...
        adb.setPositiveButton("Next", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface di, int id){
                Intent intent=new Intent(Main32Activity.this,Main33Activity.class);
                Main32Activity.this.startActivity(intent);
                Main32Activity.this.finish();
            }
        });
