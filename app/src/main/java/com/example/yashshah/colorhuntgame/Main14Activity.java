...
public class Main14Activity extends AppCompatActivity {
    ...
    public void check(String s)
    {
        ...
        if(s.equals(s2))
        {
            ...
            if(i1==0)
            {
                ...
                //Main14Activity.this.startActivity(intent);
                //t1.setText("Hurray!!!! You Completed a word match of Color Words");
                //progress.show();
                t1.setText(" ");
                b1.setEnabled(false);
                b2.setEnabled(false);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET,
                        "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"3"+"&glevel="+"9"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(Main14Activity.this);
    ...
    public void pass()
    {
        ...
        ad=adb.create();
        ad.setTitle("Hurray!!!! You Completed a Word Match of Color Words");
        ad.show();
    }
    @Override
