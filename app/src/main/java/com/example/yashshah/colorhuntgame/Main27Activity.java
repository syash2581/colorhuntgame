            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main27Activity.this,Main2Activity.class);
                        Main27Activity.this.startActivity(intent);
                        Main27Activity.this.finish();
                    }
                });
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main27Activity.this.finish();
                        Intent intent=new Intent(Main27Activity.this,Main27Activity.class);
                        Main27Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
                ...
                if(i1==0)
                {
                 //pass();
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"4"+"&glevel="+"2"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main27Activity.this);
