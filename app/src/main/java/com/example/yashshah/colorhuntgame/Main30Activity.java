...
public class Main30Activity extends AppCompatActivity {
            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main30Activity.this,Main2Activity.class);
                        Main30Activity.this.startActivity(intent);
                ...
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main30Activity.this.finish();
                        Intent intent=new Intent(Main30Activity.this,Main30Activity.class);
                        Main30Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
            ...
            if(s.equals(s2))
            {
                ...
                if(i1==0)
                {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"3"+"&glevel="+"1"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main30Activity.this);
            ...
            if(bcol.equals(s))
            {
                ...
                if(i1==0)
                {
                   // pass();
                    ...
                    progress.show();
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"4"+"&glevel="+"5"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                            new Response.Listener<String>(){
                                @Override
                                public void onResponse(String response){
                                    //Toast.makeText(MainActivity.this,"In onResponse Method",Toast.LENGTH_LONG).show();
    ...
    public void pass()
    {
        ...
        adb.setPositiveButton("Next", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface di, int id){
                Intent intent=new Intent(Main30Activity.this,Main31Activity.class);
                Main30Activity.this.startActivity(intent);
                Main30Activity.this.finish();
            }
        });
