        ...
        public void onFinish() {
            ...
            adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                public void onClick(DialogInterface di, int id){
                    Intent intent=new Intent(Main36Activity.this,Main2Activity.class);
                    Main36Activity.this.startActivity(intent);
                    Main36Activity.this.finish();
                }
            });
            adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                public void onClick(DialogInterface di, int id){
                    Main36Activity.this.finish();
                    Intent intent=new Intent(Main36Activity.this,Main36Activity.class);
                    Main36Activity.this.startActivity(intent);
                }
            });
            ad=adb.create();
            ...
            if(s.equals(blk.getText().toString()))
            {
                ...
                if(i1==0)
                {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"6"+"&glevel="+"1"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                            new Response.Listener<String>(){
                                @Override
                                public void onResponse(String response){
//                                        Toast.makeText(Main36Activity.this,"In onResponse Method",Toast.LENGTH_LONG).show();
                                    if (response.trim().equalsIgnoreCase("Failure")){
                                        progress.dismiss();
                                        //pass();
                                        //Toast.makeText(Main36Activity.this, response+"Invalid user id or Password or\nmay be user is not registered", Toast.LENGTH_LONG).show();
                                    }else {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toast.makeText(Main36Activity.this, error.toString(), Toast.LENGTH_LONG).show();
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main36Activity.this);
    ...
    public void pass()
    {
        ...
        adb.setPositiveButton("Next", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface di, int id){
                Intent intent=new Intent(Main36Activity.this,Main37Activity.class);
                Main36Activity.this.startActivity(intent);
                Main36Activity.this.finish();
            }
        });
