            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main54Activity.this,Main2Activity.class);
                        Main54Activity.this.startActivity(intent);
                        Main54Activity.this.finish();
                    }
                });
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main54Activity.this.finish();
                        Intent intent=new Intent(Main54Activity.this,Main54Activity.class);
                        Main54Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
    ...
    public void set()
    {
        ...
        else
        {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET,
                    "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"5"+"&glevel="+"9"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    new Response.Listener<String>(){
                        @Override
                        public void onResponse(String response){
//                                        Toast.makeText(Main54Activity.this,"In onResponse Method",Toast.LENGTH_LONG).show();
                            if (response.trim().equalsIgnoreCase("Failure")){
                                progress.dismiss();
                                //pass();
                                //Toast.makeText(Main54Activity.this, response+"Invalid user id or Password or\nmay be user is not registered", Toast.LENGTH_LONG).show();
                            }else {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(Main54Activity.this, error.toString(), Toast.LENGTH_LONG).show();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Main54Activity.this);
