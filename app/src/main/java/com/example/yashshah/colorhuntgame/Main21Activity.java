            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main21Activity.this,Main2Activity.class);
                        Main21Activity.this.startActivity(intent);
                ...
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main21Activity.this.finish();
                        Intent intent=new Intent(Main21Activity.this,Main21Activity.class);
                        Main21Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
        ...
        if(bcol.equals(s))
        {
            ...
            if(i1==0)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET,
                        "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"2"+"&glevel="+"6"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(Main21Activity.this);
