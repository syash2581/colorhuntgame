...
public class Main65Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Main65Activity.this);
        requestQueue.add(stringRequest);



        //lvl=Integer.parseInt(ReadingActivity.glevel);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main56Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main57Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main58Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main59Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main60Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
        b6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main61Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
        b7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main62Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
        b8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main63Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
        b9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main65Activity.this,Main64Activity.class);
                Main65Activity.this.startActivity(intent);
                Main65Activity.this.finish();
            }
        });
    ...
    public void test()
    {
        switch (lvl) {
            case 0:
                ...
                adb.setMessage("=>There is a alphabets arranged in table form and different order.\n=>User find a letter from this table form which is given after find me ... in fraction of time...");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Main65Activity.this,Main2Activity.class);
        Main65Activity.this.startActivity(intent);
        Main65Activity.this.finish();
    }
}
