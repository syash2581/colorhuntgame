            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        ...
                        Main23Activity.this.startActivity(intent);
                ...
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main23Activity.this.finish();
                        Intent intent=new Intent(Main23Activity.this,Main23Activity.class);
                        Main23Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
        ...
        if(bcol.equals(s))
        {
            ...
            if(i1==0)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET,
                        "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"2"+"&glevel="+"8"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(Main23Activity.this);
