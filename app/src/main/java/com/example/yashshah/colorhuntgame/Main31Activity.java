...
public class Main31Activity extends AppCompatActivity {
            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main31Activity.this,Main2Activity.class);
                        Main31Activity.this.startActivity(intent);
                        Main31Activity.this.finish();
                    }
                });
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main31Activity.this.finish();
                        Intent intent=new Intent(Main31Activity.this,Main31Activity.class);
                        Main31Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
                ...
                if(i1==0)
                {
                  //pass();
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"4"+"&glevel="+"6"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main31Activity.this);
    ...
    public void pass()
    {
        ...
        adb.setPositiveButton("Next", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface di, int id){
                Intent intent=new Intent(Main31Activity.this,Main32Activity.class);
                Main31Activity.this.startActivity(intent);
                Main31Activity.this.finish();
            }
        });
