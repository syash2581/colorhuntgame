...
public class Main34Activity extends AppCompatActivity {
            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main34Activity.this,Main2Activity.class);
                        Main34Activity.this.startActivity(intent);
                        Main34Activity.this.finish();
                    }
                });
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main34Activity.this.finish();
                        Intent intent=new Intent(Main34Activity.this,Main34Activity.class);
                        Main34Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
            ...
            if(s.equals(s2))
            {
                ...
                if(i1==0)
                {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"4"+"&glevel="+"9"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main34Activity.this);
    ...
    public void pass()
    {
        ...
        ad=adb.create();
        ad.setTitle("Hurray!!!! You Completed a Expert of Color Words");
        ad.show();
    }
    @Override
