...
public class Main25Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Main25Activity.this);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main26Activity.class);
                Main25Activity.this.startActivity(intent);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main27Activity.class);
                Main25Activity.this.startActivity(intent);
                Main25Activity.this.finish();
            }
        });
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main28Activity.class);
                Main25Activity.this.startActivity(intent);
                Main25Activity.this.finish();
            }
        });
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main29Activity.class);
                Main25Activity.this.startActivity(intent);
                Main25Activity.this.finish();
            }
        });
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main30Activity.class);
                Main25Activity.this.startActivity(intent);
                Main25Activity.this.finish();
            }
        });
        b6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main31Activity.class);
                Main25Activity.this.startActivity(intent);
                Main25Activity.this.finish();
            }
        });
        b7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main32Activity.class);
                Main25Activity.this.startActivity(intent);
                Main25Activity.this.finish();
            }
        });
        b8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main33Activity.class);
                Main25Activity.this.startActivity(intent);
                Main25Activity.this.finish();
            }
        });
        b9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main25Activity.this,Main34Activity.class);
                Main25Activity.this.startActivity(intent);
                Main25Activity.this.finish();
            }
        });
    ...
    public void test()
    {
        switch (lvl)
        {
            case 0:
                ...
                adb.setMessage("=>This game is a combination of Word Match and Color Match\n=>There is an One word of color name.\n=>Each Time also mention whether it is a word match or color match. \n=>Follow the instruction given above on the word");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Main25Activity.this,Main4Activity.class);
        Main25Activity.this.startActivity(intent);
        Main25Activity.this.finish();
    }
}
