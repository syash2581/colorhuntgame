...
public class Main20Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("Color Match");

        t1=(TextView)findViewById(R.id.textView10);
        t1.setText("Red");
        bcol="Blue";
        t1.setTextColor(Color.parseColor(bcol));
        set();
            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main20Activity.this,Main2Activity.class);
                        Main20Activity.this.startActivity(intent);
                ...
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main20Activity.this.finish();
                        Intent intent=new Intent(Main20Activity.this,Main20Activity.class);
                        Main20Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                check(b1.getText().toString());
            }});
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                check(b2.getText().toString());
            }});
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                check(b3.getText().toString());
            }});
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                check(b4.getText().toString());
            }
        });
    }
        ...
        if(bcol.equals(s))
        {
            ...
            if(i1==0)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET,
                        "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"2"+"&glevel="+"5"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(Main20Activity.this);
    ...
    public void pass()
    {
        ...
        progress.dismiss();
        progress.dismiss();adb=new AlertDialog.Builder(this);
        adb.setCancelable(false);
