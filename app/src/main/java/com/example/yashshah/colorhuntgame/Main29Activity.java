            ...
            public void onFinish() {
                ...
                adb.setPositiveButton("Ok", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Intent intent=new Intent(Main29Activity.this,Main2Activity.class);
                        Main29Activity.this.startActivity(intent);
                        Main29Activity.this.finish();
                    }
                });
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main29Activity.this.finish();
                        Intent intent=new Intent(Main29Activity.this,Main29Activity.class);
                        Main29Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
            ...
            if(s.equals(s2))
            {
                ...
                if(i1==0)
                {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET,
                            "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"4"+"&glevel="+"4"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Main29Activity.this);
...
public void pass()
{
    ...
    adb.setPositiveButton("Next", new DialogInterface.OnClickListener(){
        public void onClick(DialogInterface di, int id){
            Intent intent=new Intent(Main29Activity.this,Main30Activity.class);
            Main29Activity.this.startActivity(intent);
            Main29Activity.this.finish();
        }
    });
