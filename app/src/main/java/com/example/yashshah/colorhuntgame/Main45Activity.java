...
public class Main45Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Main45Activity.this);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main46Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main47Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main48Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main49Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main50Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
        b6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main51Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
        b7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main52Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
        b8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main53Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
        b9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Main45Activity.this,Main54Activity.class);
                Main45Activity.this.startActivity(intent);
                Main45Activity.this.finish();
            }
        });
...
public void test()
{
    switch (lvl)
    {
        case 0:
            ...
            adb.setMessage("=>In this game there is an one piano.\n=>In this piano there are two blocks of white and black color.\n=>Black or white block containing colors name along with textColor.\n=>so , basically it's necessary for user to selectt any color from below given color blocks.\n=>whatever given in black box user play as a Color Match and whatever given in white box user play as a word match.");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Main45Activity.this,Main2Activity.class);
        Main45Activity.this.startActivity(intent);
        Main45Activity.this.finish();
    }
}
