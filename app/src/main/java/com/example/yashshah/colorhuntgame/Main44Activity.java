...
public class Main44Activity extends AppCompatActivity {
    ...
    final CountDownTimer c2 = new CountDownTimer(t * 1000, 1000) {
        ...
        public void onFinish() {
            ...
            adb.setMessage("Your Score is:" + ((i2 - i1) * 10));
            adb.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface di, int id) {
                    Intent intent = new Intent(Main44Activity.this, Main2Activity.class);
                    Main44Activity.this.startActivity(intent);
                    Main44Activity.this.finish();
                }
            });
            adb.setNegativeButton("Retry", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface di, int id) {
                    Main44Activity.this.finish();
                    Intent intent = new Intent(Main44Activity.this, Main44Activity.class);
                    Main44Activity.this.startActivity(intent);
                }
            });
            ad = adb.create();
        ...
        if (s.equals(blk.getText().toString())) {
            ...
            if (i1==0) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET,
                        "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"6"+"&glevel="+"9"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                        new Response.Listener<String>(){
                            @Override
                            public void onResponse(String response){
//                                        Toast.makeText(Main44Activity.this,"In onResponse Method",Toast.LENGTH_LONG).show();
                                if (response.trim().equalsIgnoreCase("Failure")){
                                    progress.dismiss();
                                    //pass();
                                    //Toast.makeText(Main44Activity.this, response+"Invalid user id or Password or\nmay be user is not registered", Toast.LENGTH_LONG).show();
                                }else {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Main44Activity.this, error.toString(), Toast.LENGTH_LONG).show();
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(Main44Activity.this);
