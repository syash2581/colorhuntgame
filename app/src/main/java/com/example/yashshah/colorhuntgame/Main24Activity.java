        ...
        t3=new  CountDownTimer((t*1000), 1000) {
            ...
            public void onFinish() {
                ...
                adb.setNegativeButton("Retry", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface di, int id){
                        Main24Activity.this.finish();
                        Intent intent=new Intent(Main24Activity.this,Main24Activity.class);
                        Main24Activity.this.startActivity(intent);
                    }
                });
                ad=adb.create();
        ...
        if(bcol.equals(s))
        {
            ...
            if(i1==0)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET,
                        "http://send-otp-for-free.000webhostapp.com/Color_Hunt_Game/writing.php?uid="+SignInActivity.uid+"&gid="+"2"+"&glevel="+"9"+"&time="+String.valueOf(t)+"&score="+String.valueOf(score),
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(Main24Activity.this);
...
public void pass()
{
    ...
    ad=adb.create();
    ad.setTitle("Hurray!!!! You Completed a Color Match of Color Words");
    ad.show();
